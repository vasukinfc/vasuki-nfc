const CACHE="vasuki-smart-v8-official-links";
const ASSETS=["./","./index.html","./login.html","./customer.html","./owner.html","./styles.css","./smart-card.css","./manifest.webmanifest","./owner-manifest.webmanifest","./icon.svg"];
